...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? '94705900209' : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'Dark-Robin' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? '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' : process.env.GITHUB_AUTH_TOKEN, //ADD YOUR GITHUB AUTH TOKEN WITHOUT gph_ ,  example - G5OxxdvEbiBPWxm4A0xypQGlyCr4FS267ifz
    ...
    OWNER: process.env.OWNER === undefined ? `94704101989` : process.env.OWNER, //BOTS OWNER NUMBER
